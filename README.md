...
Rôle         : Ingénieur Réseaux & Sécurité 
Passion      : Sécuriser, automatiser, innover ☁️🔒
```

> _"Ingénieur réseaux et sécurité passionné par le Cloud et les pratiques DevOps"_

Spécialisé en infrastructures réseau, cybersécurité et architectures cloud AWS, je combine une  expertise en sécurité réseau avec des compétences Cloud modernes (AWS, Docker/Kubernetes, Terraform, Jenkins).

**Focus actuel :** Déploiement d'applications Full-Stack avec pipelines CI/CD, automatisation IaC (Infrastructure as Code) et monitoring avancé, ainsi que la mise en place d'un SOC (Security Operations Center) et de pratiques DevOps.
...
|---------|---------------|---------|
| 🔶 2026 | **Orange Digital Center** — Sénégal | Formation AWS re/Start (Cloud & DevOps) |
| 🎓 2021 – 2023 | **Université Gaston Berger** — Saint-Louis | Master Réseaux, Sécurité et Systèmes Distribués |
| 📚 2024 (08-10) | **Simplon Sénégal** | Formation Technicien Support Réseau |
| 📚 2016 – 2019 | **Université Alioune Diop** — Bambey | Licence Administration et Maintenance Réseaux |
| 📖 2016 | **Lycée Demba Diop** | Baccalauréat Série S2 |
...
[![Email](https://img.shields.io/badge/Email-siakha.kaba01@gmail.com-0066FF?style=for-the-badge&logo=gmail&logoColor=white)](mailto:siakha.kaba49@gmail.com)
